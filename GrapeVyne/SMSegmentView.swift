...
open class SMSegmentView: UIControl {
    ...
    open func addSegmentWithAttributedTitle(_ attributedTitle: NSMutableAttributedString?, onSelectionImage: UIImage?, offSelectionImage: UIImage?) {
        self.insertSegmentWithAttributedTitle(attributedTitle, onSelectionImage: onSelectionImage, offSelectionImage: offSelectionImage, index: self.segments.count)
    }
    ...
    open func insertSegmentWithAttributedTitle(_ attributedTitle: NSMutableAttributedString?, onSelectionImage: UIImage?, offSelectionImage: UIImage?, index: Int) {
