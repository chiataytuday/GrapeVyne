...
//  GrapeVyne
//
//  Created by Umair Sharif on 3/4/17.
...
class CustomColor: UIColor {
    // CardView
    static let textPurple = UIColor(red: 127/255, green: 63/255, blue: 152/255, alpha: 1.0)
    static let textGreen = UIColor(red: 57/255, green: 181/255, blue: 74/255, alpha: 1.0)
